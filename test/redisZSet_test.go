...
//	add, _ := client.ZSet.Add("key_set_z", &redis.redisZ{1, "小猫"}, &redis.redisZ{2, "小狗"}, &redis.redisZ{3, "小鸟"})
...
//	client := redis.NewClient("default")
//	defer client.Key.Del("key_set_z")
//	client.ZSet.Add("key_set_z", &redis.redisZ{1, "小猫"}, &redis.redisZ{2, "小狗"}, &redis.redisZ{3, "小鸟"})
